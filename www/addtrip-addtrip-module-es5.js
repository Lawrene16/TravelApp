...
var AddtripPage = /** @class */ (function () {
    ...
    AddtripPage.prototype.uploadTrip = function () {
        ...
        this.loadingCtrl.create({ message: "Uploading your trip" }).then(function (res) {
            res.present();
            _this.travelAppService.addTrip(_this.useruid, _this.aboutTrip, _this.city, _this.date, _this.eventTitle, _this.province, _this.base64TripPhoto).then(function () {
                res.dismiss();
                _this.aboutTrip = "";
                _this.city = "";
                _this.date = "";
