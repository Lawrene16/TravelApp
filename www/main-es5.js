...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, travelAppService, router, splashScreen, statusBar) {
    ...
    AppComponent.prototype.checkPage = function (p) {
        ...
        if (p.title == "Logout") {
            firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signOut().then(function () {
                _this.router.navigateByUrl(p.url);
            });
            console.log("ressss");
        }
        else {
...
var TravelAppService = /** @class */ (function () {
    function TravelAppService(faceBook, googlePlus) {
    ...
    // Creates a new user
    TravelAppService.prototype.createnewuser = function (firstname, lastname, email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.fireauth
                ...
                _this.firedata
                    .ref("/users")
                    .child(_this.fireauth.currentUser.uid)
                    .set({
                    firstname: firstname,
                    lastname: lastname,
                    email: email
    ...
    TravelAppService.prototype.facebookLogin = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.faceBook.login(['email', 'public_profile']).then(function (response) {
                var facebookCredential = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"].FacebookAuthProvider.credential(response.authResponse.accessToken);
                firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithCredential(facebookCredential).then(function (result) {
    ...
    // Login with google
    TravelAppService.prototype.googleLogin = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.googlePlus.login({
                ...
                var googleCredential = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider.credential(response.idToken);
                firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithCredential(googleCredential)
    ...
    // Login with email
    TravelAppService.prototype.loginExistingUser = function (email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.fireauth
    ...
    TravelAppService.ctorParameters = function () { return [
