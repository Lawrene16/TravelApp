...
var RegisterPage = /** @class */ (function () {
    ...
    RegisterPage.prototype.checkIfUserExits = function (userId) {
    ...
    RegisterPage.prototype.register = function () {
        ...
        if (this.name == "" || this.name.length < 2) {
            ...
            this.loadingController.create({
                ...
                res.present();
                _this.travelAppService.createnewuser(_this.email, _this.password).then(function () {
                    _this.travelAppService.generateInitialUserDetails(_this.name, _this.email, "").then(function () {
                        res.dismiss();
                        _this.router.navigateByUrl('/tabs');
                    }).catch(function (err) {
                        res.dismiss();
