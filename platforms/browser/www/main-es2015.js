...
var map = {
	...
	"./tripdetails/tripdetails.module": [
...
/* harmony import */ var _travel_app_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./travel-app.service */ "./src/app/travel-app.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, travelAppService, router, splashScreen, statusBar) {
...
AppComponent.ctorParameters = () => [
    ...
    { type: _travel_app_service__WEBPACK_IMPORTED_MODULE_6__["TravelAppService"] },
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"],
        _travel_app_service__WEBPACK_IMPORTED_MODULE_6__["TravelAppService"],
...
/***/ "./src/app/travel-app.service.ts":
/*!***************************************!*\
  !*** ./src/app/travel-app.service.ts ***!
  \***************************************/
/*! exports provided: TravelAppService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TravelAppService", function() { return TravelAppService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! firebase */ "./node_modules/firebase/dist/index.cjs.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(firebase__WEBPACK_IMPORTED_MODULE_2__);
...
let TravelAppService = class TravelAppService {
    // Note the parent id is the ID of the parent not the parent_id of the parent
    constructor(faceBook, googlePlus, httpClient, toastCtrl) {
    ...
    generateInitialUserDetails(name, email, photo) {
        return new Promise((resolve, reject) => {
            this.firedata
                ...
                email: email,
                coverPhoto: "",
                aboutMe: "About me has not been set. Click on the edit icon to tell us about yourself",
                followers: "0",
                following: "0",
                photoURL: photo,
                provincesVisited: "0"
    ...
    uploadProfilePic(useruid, photoString) {
        return new Promise((resolve, reject) => {
            var storageRef = this.firestore
                ...
                .child(useruid + ".jpg");
            storageRef
                .putString(photoString, firebase__WEBPACK_IMPORTED_MODULE_2__["storage"].StringFormat.DATA_URL)
                .then(res => {
        ...
        return new Promise((resolve, reject) => {
            this.faceBook.getLoginStatus().then((res) => {
                if (res.status === 'connected') {
                    ...
                    let credentials2 = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"].FacebookAuthProvider.credential(res.authResponse.accessToken);
                    firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithCredential(credentials2).then((result2) => {
                    ...
                    this.faceBook.login(['public_profile', 'user_friends', 'email'])
                        ...
                        const facebookCredential = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"].FacebookAuthProvider.credential(response.authResponse.accessToken);
                        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithCredential(facebookCredential)
                            .then(result => {
    ...
    googleLogin() {
        return new Promise((resolve, reject) => {
            this.googlePlus
                ...
                .then(response => {
                const googleCredential = firebase__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider.credential(response.idToken);
    ...
    // Fetch all countries
    fetchAllCountries() {
        var fetchCountriesURL = "https://ezcmd.com/apps/api_ezhigh/get_countries/9548d4dd520add28122862b784a9da1c/673";
        return new Promise((resolve, reject) => {
            this.httpClient.get(fetchCountriesURL).subscribe(data => {
                resolve(data);
            }, err => {
                reject(err);
            });
    ...
    fetchAllStates(countrycode) {
        var fetchStatesURL = "https://ezcmd.com/apps/api_ezhigh/get_hierarchy/9548d4dd520add28122862b784a9da1c/673?country_code=" +
            countrycode +
            "&level=1";
        return new Promise((resolve, reject) => {
            this.httpClient.get(fetchStatesURL).subscribe(data => {
                resolve(data);
            }, err => {
                reject(err);
            });
    ...
    fetchAllCities(countrycode, stateid) {
        var fetchCitiesURL = "https://ezcmd.com/apps/api_ezhigh/get_hierarchy/9548d4dd520add28122862b784a9da1c/673?country_code=" + countrycode + "&parent_id=" + stateid + "&level=2";
        return new Promise((resolve, reject) => {
            this.httpClient.get(fetchCitiesURL).subscribe(data => {
                resolve(data);
            }, err => {
                reject(err);
            });
...
TravelAppService.ctorParameters = () => [
...
TravelAppService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
