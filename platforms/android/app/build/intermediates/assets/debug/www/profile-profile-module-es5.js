...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(toastCtrl, 
    // public crop: Crop,
    ...
    ProfilePage.prototype.saveProfile = function () {
        ...
        if (this.firstname == "" || this.lastname == "") {
            ...
            this.loadingCtrl.create({ message: "Please wait" }).then(function (res) {
                res.present();
                _this.travelAppService.updateUserDetails(_this.firstname, _this.lastname, _this.phonenumber, _this.aboutMe, _this.myimage).then(function () {
